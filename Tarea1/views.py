...
def episode(request, id): #sin id, url ni creación
    ...
    episode_template = open(BASE_DIR + "/Tarea1/Templates/episode_temp.html")
...
def character(request, id): #sin id, url ni creación. Con todos sus lugares y episodios
    ...
    character_template = open(BASE_DIR + "/Tarea1/Templates/character_temp.html")
...
def location(request, id):
    ...
    location_template = open(BASE_DIR + "/Tarea1/Templates/location_temp.html")
...
def search(request): #iterar sobre las pages
    ...
    search_template = open(BASE_DIR + "/Tarea1/Templates/search_temp.html")
